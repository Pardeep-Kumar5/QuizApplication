...
namespace QuizApplicationBackend.Migrations
{
    ...
    [Migration("20230708074702_AddStudentScoreTable")]
    partial class AddStudentScoreTable
    {
            ...
            modelBuilder.Entity("QuizApplicationBackend.Model.StudentScoreTable", b =>
                {
                    ...
                    b.Property<int?>("registerTableid")
                        .HasColumnType("int");

                    b.HasKey("ScoreID");

                    b.HasIndex("registerTableid");
